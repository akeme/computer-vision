'''
Questão 21
Faça o mesmo que o tópico 20, alterando apenas o modo de inicializar a 
semente, onde esta deve ser inicializada com um click na imagem
apresentada pela OpenCv.
...
if __name__ == '__main__':
    # Read a rgb image
    image = cv2.imread('img/q20.jpg') #utilizada imagem q anterior
