'''
Questão 22
Faça o mesmo que o tópico 21, calculando no final o centroide do 
objeto segmentado pelo método Crescimento de Regiões 2D, apresentando 
a região segmentada em azul e o centroide em verde.
'''
...
if __name__ == '__main__':
    # Read a rgb image
    image = cv2.imread('img/q20.jpg') #utilizando a mesma imagem da q 20
