'''
Questão 27
Faça o mesmo que a questão 26, entretanto gere subimagens com os 
objetos detectados e apresente estas subimagens, uma em cada janela.
...
if __name__ == '__main__':
    # Read a rgb image
    image = cv2.imread('img/figuras.png')
