...
%  P = TWOMODEGAUSS(M1, SIG1, M2,SIG2, A1, A2, K) generatesa bimodal,
...
%  amplitude values of the two modes. Since the output is normalized, only
%  the relative values of A1 and A2 are important. K is an offset value
%  that raises the "floor" of the function. A good set of values to try is
%  M1 = 0.15, SIG1 = 0.05, M2 = 0.75, SIG2 = 0.05, A1 = 1, A2 = 0.07, and K
%  = 0.002.
