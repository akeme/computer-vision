...
% range [LOW, HIGH]. These values must be provided, and they must be in the
% range [0, 1], independently of the class of the input. GSCALE performs
% any necessary scaling. If the input is of class double, and its values
% are not in the range [0, 1], then GSCALE scales it to this range before
% processing.
%
...
switch method
    ...
    case 'minmax'
        ...
        if low >1 | low < 0 | high > 1 | high < 0
            error('The parameters low and high must be in the range [0, 1].')
        end
        ...
        g = imadjust(f, [ low_in high_in], [lw high]);
    otherwise
